    ...
    const mount = async () => {
      ...
      try {
        ...
        win.document.body.innerHTML = `
          <style>
            html,body{margin:0;height:100%;background:#0f1c1c;color:#f4f1ea;font-family:Figtree,system-ui,sans-serif;display:grid;place-items:center}
            .t{font-size:42px;font-weight:700;letter-spacing:-0.04em}
